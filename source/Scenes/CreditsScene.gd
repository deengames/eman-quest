...
func _ready():
	...
	$TheEndLabel.visible = true
	$TheEndLabel.modulate.a = 0
	...
	tween2.interpolate_property($ThanksLabel, "margin_top", _VISIBLE, _INVISIBLE, _CONGRATS_FADE_TIME_SECONDS, Tween.TRANS_LINEAR, Tween.EASE_IN)
	tween2.start()
